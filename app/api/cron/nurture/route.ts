...
import { advanceDueRecipients } from '@/lib/nurture'
...
/**
 * POST /api/cron/nurture — advance due nurture-drip emails for all agencies.
...
export async function POST(req: Request) {
  ...
  for (const agency of agencies || []) {
    const summary = await advanceDueRecipients(agency.id)
