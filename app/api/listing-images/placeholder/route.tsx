...
const INDUSTRY_EMOJI: Record<string, string> = {
  ...
  'smoke': '🚬', 'vape': '💨', 'tobacco': '🚬', 'indian': '🛒', 'grocery': '🛒',
  'dollar': '💵', 'cell phone': '📱', 'electronics': '📺', 'book': '📚',
  'gift': '🎁', 'florist': '💐', 'jewelry': '💍', 'hardware': '🔨',
  'furniture': '🛋️', 'appliance': '🔌', 'sporting': '⚽', 'bicycle': '🚲',
  'toy': '🧸', 'game': '🎮', 'pawn': '💠', 'thrift': '🧥', 'boutique': '👗',
  'shoe': '👟', 'mattress': '🛏️', 'optical': '👓', 'health food': '🥗',
  'supplement': '💊', 'tea': '🍵', 'hookah': '💨', 'cannabis': '🌿', 'cbd': '🌿',
  'pizza': '🍕', 'fast food': '🍔', 'ice cream': '🍦', 'donut': '🍩',
  'smoothie': '🥤', 'juice': '🧃', 'bar': '🍸', 'pub': '🍺', 'nightclub': '🪩',
  'brewery': '🍺', 'distillery': '🥃', 'winery': '🍷', 'deli': '🥪',
  'butcher': '🥩', 'seafood': '🦞', 'produce': '🥦', 'ghost kitchen': '🍳',
  'meal prep': '🥗', 'candy': '🍬', 'chocolate': '🍫',
  'remodeling': '🏠', 'kitchen & bath': '🛁', 'masonry': '🧱', 'fencing': '🚧',
  'flooring': '🪵', 'drywall': '🧱', 'insulation': '🧊', 'siding': '🏠',
  'window cleaning': '🪟', 'carpet': '🧹', 'pressure washing': '🚿',
  'handyman': '🔧', 'tree': '🌳', 'snow': '❄️', 'lawn': '🌱', 'arborist': '🌳',
  'pool': '🏊', 'pest': '🐜', 'auto body': '🚗', 'auto glass': '🪟',
  'tire': '🛞', 'oil change': '🛢️', 'motorcycle': '🏍️', 'boat': '⛵',
  'rv': '🚐', 'marina': '⚓', 'towing': '🚛', 'moving': '📦', 'courier': '🚚',
  'freight': '🚛', 'urgent care': '🚑', 'clinic': '🏥', 'chiropractic': '🦴',
  'optometry': '👁️', 'audiology': '👂', 'massage': '💆', 'med spa': '✨',
  'dermatology': '🧴', 'dental lab': '🦷', 'hospice': '🕊️', 'senior care': '👵',
  'assisted living': '🏠', 'medical billing': '🧾', 'locksmith': '🔑',
  'alarm': '🚨', 'fire protection': '🧯', 'mortgage': '🏦', 'tax': '🧾',
  'payroll': '💰', 'recruiting': '🤝', 'public relations': '📣',
  'web design': '🖥️', 'seo': '🔍', 'social media': '📱', 'photography': '📷',
  'videography': '🎥', 'event planning': '🎉', 'dj': '🎧', 'app development': '📱',
  'data analytics': '📊', 'cybersecurity': '🔒', 'managed services': '🖥️',
  'computer repair': '💻', 'phone repair': '📱', 'self storage': '🗄️',
  'mini storage': '📦', 'metal fabrication': '🔩', 'machine shop': '⚙️',
  'cnc': '🛠️', 'welding': '🔥', 'plastics': '🧴', 'injection molding': '🏭',
  'packaging': '📦', 'screen printing': '👕', 'sign': '🪧', 'textile': '🧵',
  'garment': '👕', 'bed & breakfast': '🛏️', 'vacation rental': '🏖️',
  'campground': '⛺', 'yoga': '🧘', 'pilates': '🤸', 'crossfit': '🏋️',
  'martial arts': '🥋', 'dance': '💃', 'tattoo': '💉', 'piercing': '📿',
  'tanning': '☀️', 'dry cleaner': '🧺', 'tailor': '🪡', 'test prep': '📝',
  'driving school': '🚗', 'music school': '🎵', 'art school': '🎨',
  'language': '🗣️', 'preschool': '🧸', 'after school': '🏫', 'arcade': '🕹️',
  'bowling': '🎳', 'golf': '⛳', 'escape room': '🧩', 'trampoline': '🤸',
  'karaoke': '🎤', 'farm': '🚜', 'ranch': '🐄', 'greenhouse': '🌱',
  'nursery': '🌷', 'garden center': '🌻', 'feed store': '🌾', 'livestock': '🐑',
}
