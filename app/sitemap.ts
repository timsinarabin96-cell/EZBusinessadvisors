...
const STATIC: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/brokerai`, changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/valuation`, changeFrequency: 'weekly', priority: 0.7 },
  { url: `${BASE}/pnl-builder`, changeFrequency: 'monthly', priority: 0.6 },
