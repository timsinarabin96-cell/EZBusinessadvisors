...
export function listingToReadinessInput(row: any): IntelligentListingInput {
  return {
    ...
    franchise_agreements: row.franchise_agreements || '',
    pending_litigation: row.pending_litigation || '',
    environmental_issues: row.environmental_issues || '',
    key_customer_contracts: row.key_customer_contracts || '',
    key_supplier_contracts: row.key_supplier_contracts || '',
    years_at_location: row.years_at_location != null ? String(row.years_at_location) : '',
    re_professional_name: row.re_professional_name || '',
    re_professional_contact: row.re_professional_contact || '',
    re_professional_license: row.re_professional_license || '',
    re_professional_role: row.re_professional_role || '',
